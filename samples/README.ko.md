...
각 샘플의 `#:sdk` 줄에는 최신 게시 버전을 정확히 핀해야 합니다 (현재 이 폴더의 파일들은 `Cadenza@1.0.9`, `Cadenza.Worker@1.0.9`, `Cadenza.Web@1.0.9`, `Cadenza.Mcp@1.0.9`로 고정). MSBuild SDK 참조는 정확한 버전만 받습니다 — 자세한 내용은 [docs/troubleshooting.ko.md](../docs/troubleshooting.ko.md).
